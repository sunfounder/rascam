...
class RGB_Matrix():
    ...
    def show_text(self,text, delay=0.1,color=(0,15,0)):
        # text = "  " + str(text)
        text = str(text)
        ...
        for i in range(0, -size, -1):
            if not self.flag:
                break
            self.draw.text((i, -1), text,  font=self.font, fill=color)
...
if __name__=='__main__':
    ...
    # rr.show_text("7")
    # time.sleep(1)
    # rectangle_coor = [0,0,6,0]
    # rr.draw_rectangle(rectangle_coor,fill=(255,255,255),outline=None, width=0)   #draw a rectangle
    # rr.draw_line(rectangle_coor,fill=(255,255,255),width=0, joint=None)
    # rr.display()
    rr.draw_point((1,0),fill=(10,10,10))
    rr.display()
    # for i in range(250):
    #     print(i)
    #     rr.draw_rectangle(rectangle_coor,fill=(i,0,0),outline=None, width=0)   #draw a rectangle
    #     rr.display()
    #     # time.sleep(0.002)
    ...
    #         print(k)
    #         rr.draw_point([i,k],(0,10-i,0))
    #         rr.draw_point([i,k+1],(10-i,0,0)) 
