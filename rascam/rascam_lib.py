...
#picture
    ...
    detect_obj_parameter['watermark_flag'] = False
    ...
    detect_obj_parameter['horizontal_line'] = True
...
# 使用白色填充图片区域,默认为黑色
    ...
    @staticmethod
    def horizontal_line(flag):
        # global button_motion

        Ras_Cam.detect_obj_parameter['horizontal_line'] = flag
